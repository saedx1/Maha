...
Usage::
    $ python tools/gen_changelog.py [OPTIONS] TOKEN PRIOR TAG [ADDITIONAL]...
...
From a bash command line with $GITHUB environment variable as the GitHub token::
    $ python tools/gen_changelog.py $GITHUB v0.1.0 v0.2.0
This would generate 0.2.0-changelog.rst file and place it automatically under
...
providing a space separated list of ticket numbers after TAG::
    $ ./tools/gen_changelog.py $GITHUB v0.3.0 v0.4.0 1911 1234 1492 ...
